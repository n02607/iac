resource "aws_launch_configuration" "terraform-example-lc" {
...
resource "aws_autoscaling_group" "terraform-asg-example" {
	launch_configuration = aws_launch_configuration.terraform-example-lc.name
...
resource "aws_lb_target_group" "asg" {
	name = "${var.cluster_name}-alb-tg-example"
